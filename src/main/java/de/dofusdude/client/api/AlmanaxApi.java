...
import de.dofusdude.client.model.AlmanaxEntry;
...
@Path("/dofus2/{language}/almanax")
public interface AlmanaxApi  {
    ...
    AlmanaxEntry getAlmanaxDate(@PathParam("language") String language, @PathParam("date") Date date) throws ApiException, ProcessingException;
    ...
    @Produces({ "application/json" })
    List<AlmanaxEntry> getAlmanaxRange(@PathParam("language") String language, @QueryParam("filter[bonus_type]") String filterBonusType, @QueryParam("range[from]") Date rangeFrom, @QueryParam("range[to]") Date rangeTo, @QueryParam("range[size]") Integer rangeSize, @QueryParam("timezone") @DefaultValue("Europe/Paris") String timezone) throws ApiException, ProcessingException;
}
