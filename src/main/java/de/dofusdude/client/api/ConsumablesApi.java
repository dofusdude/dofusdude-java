...
@Path("/{game}/{language}/items/consumables")
public interface ConsumablesApi  {
    ...
    @Path("/{ankama_id}")
    @Produces({ "application/json" })
    Resource getItemsConsumablesSingle(@PathParam("language") String language, @PathParam("ankama_id") Integer ankamaId, @PathParam("game") String game) throws ApiException, ProcessingException;
}
