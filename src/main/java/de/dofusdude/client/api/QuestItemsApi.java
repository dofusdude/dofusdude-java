...
@Path("/{game}/{language}/items/quest")
public interface QuestItemsApi  {
    ...
    @Path("/{ankama_id}")
    @Produces({ "application/json" })
    Resource getItemQuestSingle(@PathParam("language") String language, @PathParam("ankama_id") Integer ankamaId, @PathParam("game") String game) throws ApiException, ProcessingException;
