...
import de.dofusdude.client.model.GetMetaAlmanaxBonuses200ResponseInner;
...
public interface MetaApi  {
    ...
    List<String> getGameSearchTypes() throws ApiException, ProcessingException;
    ...
    @Produces({ "application/json" })
    List<GetMetaAlmanaxBonuses200ResponseInner> getMetaAlmanaxBonuses(@PathParam("language") String language) throws ApiException, ProcessingException;
     ...
     */
    @GET
    @Path("/{language}/almanax/bonuses/search")
    @Produces({ "application/json" })
    List<GetMetaAlmanaxBonuses200ResponseInner> getMetaAlmanaxBonusesSearch(@PathParam("language") String language, @QueryParam("query") String query, @QueryParam("limit") Integer limit) throws ApiException, ProcessingException;
    ...
    @Path("/elements")
    @Produces({ "application/json" })
    List<String> getMetaElements() throws ApiException, ProcessingException;
}
