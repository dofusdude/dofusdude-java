...
public class SetEffectsEntryType {
  ...
  public SetEffectsEntryType name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public SetEffectsEntryType id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public SetEffectsEntryType isMeta(@jakarta.annotation.Nullable Boolean isMeta) {
    this.isMeta = isMeta;
    return this;
  }
  ...
  public SetEffectsEntryType isActive(@jakarta.annotation.Nullable Boolean isActive) {
