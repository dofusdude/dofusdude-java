...
public class MountListEntry {
  ...
  public MountListEntry ankamaId(@jakarta.annotation.Nullable Integer ankamaId) {
  ...
  public MountListEntry name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public MountListEntry familyName(@jakarta.annotation.Nullable String familyName) {
  ...
  public MountListEntry imageUrls(@jakarta.annotation.Nullable ImageUrls imageUrls) {
  ...
  public MountListEntry effects(@jakarta.annotation.Nullable List<EffectsEntry> effects) {
