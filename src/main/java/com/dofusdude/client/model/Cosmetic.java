...
public class Cosmetic {
  ...
  public Cosmetic ankamaId(@jakarta.annotation.Nullable Integer ankamaId) {
  ...
  public Cosmetic name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public Cosmetic description(@jakarta.annotation.Nullable String description) {
  ...
  public Cosmetic type(@jakarta.annotation.Nullable CosmeticType type) {
    this.type = type;
    return this;
  }
  ...
  public void setType(@jakarta.annotation.Nullable CosmeticType type) {
    this.type = type;
  }


  public Cosmetic level(@jakarta.annotation.Nullable Integer level) {
    this.level = level;
    return this;
  }
  ...
  public Cosmetic pods(@jakarta.annotation.Nullable Integer pods) {
    this.pods = pods;
    return this;
  }
  ...
  public Cosmetic imageUrls(@jakarta.annotation.Nullable ImageUrls imageUrls) {
  ...
  public Cosmetic effects(@jakarta.annotation.Nullable List<EffectsEntry> effects) {
  ...
  @Deprecated
  public Cosmetic conditions(@jakarta.annotation.Nullable List<ConditionEntry> conditions) {
  ...
  public Cosmetic conditionTree(@jakarta.annotation.Nullable ConditionTreeNode conditionTree) {
  ...
  public Cosmetic recipe(@jakarta.annotation.Nullable List<RecipeEntry> recipe) {
    this.recipe = recipe;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ankamaId, cosmetic.ankamaId) &&
        Objects.equals(this.name, cosmetic.name) &&
        Objects.equals(this.description, cosmetic.description) &&
        Objects.equals(this.type, cosmetic.type) &&
        Objects.equals(this.level, cosmetic.level) &&
        Objects.equals(this.pods, cosmetic.pods) &&
        Objects.equals(this.imageUrls, cosmetic.imageUrls) &&
        Objects.equals(this.effects, cosmetic.effects) &&
        Objects.equals(this.conditions, cosmetic.conditions) &&
        Objects.equals(this.conditionTree, cosmetic.conditionTree) &&
        Objects.equals(this.recipe, cosmetic.recipe);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cosmetic
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cosmetic.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cosmetic is not found in the empty JSON string", Cosmetic.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cosmetic.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cosmetic` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cosmetic.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cosmetic' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cosmetic> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cosmetic.class));

       return (TypeAdapter<T>) new TypeAdapter<Cosmetic>() {
           @Override
           public void write(JsonWriter out, Cosmetic value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cosmetic read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cosmetic given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cosmetic
   * @throws IOException if the JSON string is invalid with respect to Cosmetic
   */
  public static Cosmetic fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cosmetic.class);
  }

  /**
   * Convert an instance of Cosmetic to an JSON string
   *
   * @return JSON string
   */
