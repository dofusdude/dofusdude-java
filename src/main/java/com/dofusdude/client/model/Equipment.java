...
public class Equipment {
  ...
  public Equipment type(@jakarta.annotation.Nullable TranslatedId type) {
    this.type = type;
    return this;
  }
  ...
  public Equipment imageUrls(@jakarta.annotation.Nullable Images imageUrls) {
  ...
  public Equipment effects(@jakarta.annotation.Nullable List<Effect> effects) {
    this.effects = effects;
    return this;
  }

  public Equipment addEffectsItem(Effect effectsItem) {
  ...
  public Equipment conditions(@jakarta.annotation.Nullable ConditionNode conditions) {
  ...
  public Equipment recipe(@jakarta.annotation.Nullable List<Recipe> recipe) {
    this.recipe = recipe;
    return this;
  }

  public Equipment addRecipeItem(Recipe recipeItem) {
    if (this.recipe == null) {
  ...
  public Equipment parentSet(@jakarta.annotation.Nullable TranslatedId parentSet) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ankamaId, name, description, type, isWeapon, level, pods, imageUrls, effects, conditions, recipe, parentSet);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ankama_id", "name", "description", "type", "is_weapon", "level", "pods", "image_urls", "effects", "conditions", "recipe", "parent_set"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Equipment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Equipment is not found in the empty JSON string", Equipment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Equipment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Equipment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("recipe") != null && !jsonObj.get("recipe").isJsonNull()) {
        ...
        if (jsonArrayrecipe != null) {
          ...
          if (!jsonObj.get("recipe").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `recipe` to be an array in the JSON string but got `%s`", jsonObj.get("recipe").toString()));
          }
