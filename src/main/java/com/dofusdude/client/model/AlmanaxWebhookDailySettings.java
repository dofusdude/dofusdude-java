...
public class AlmanaxWebhookDailySettings {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("timezone", "midnight_offset"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AlmanaxWebhookDailySettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AlmanaxWebhookDailySettings is not found in the empty JSON string", AlmanaxWebhookDailySettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AlmanaxWebhookDailySettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AlmanaxWebhookDailySettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
