...
public class CreateTwitterWebhook {
  ...
  public CreateTwitterWebhook whitelist(@jakarta.annotation.Nullable List<String> whitelist) {
  ...
  public CreateTwitterWebhook blacklist(@jakarta.annotation.Nullable List<String> blacklist) {
  ...
  public CreateTwitterWebhook subscriptions(@jakarta.annotation.Nonnull Set<String> subscriptions) {
  ...
  public CreateTwitterWebhook format(@jakarta.annotation.Nonnull FormatEnum format) {
    this.format = format;
    return this;
  }
  ...
  public CreateTwitterWebhook previewLength(@jakarta.annotation.Nullable Integer previewLength) {
  ...
  public CreateTwitterWebhook callback(@jakarta.annotation.Nonnull URI callback) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("whitelist", "blacklist", "subscriptions", "format", "preview_length", "callback"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("subscriptions", "format", "callback"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateTwitterWebhook.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CreateTwitterWebhook is not found in the empty JSON string", CreateTwitterWebhook.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateTwitterWebhook.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateTwitterWebhook` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("whitelist") != null && !jsonObj.get("whitelist").isJsonNull() && !jsonObj.get("whitelist").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `whitelist` to be an array in the JSON string but got `%s`", jsonObj.get("whitelist").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("blacklist") != null && !jsonObj.get("blacklist").isJsonNull() && !jsonObj.get("blacklist").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `blacklist` to be an array in the JSON string but got `%s`", jsonObj.get("blacklist").toString()));
      }
      ...
      if (!jsonObj.get("callback").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `callback` to be a primitive type in the JSON string but got `%s`", jsonObj.get("callback").toString()));
      }
  }
