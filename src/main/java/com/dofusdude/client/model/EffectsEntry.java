...
public class EffectsEntry {
  ...
  public EffectsEntry intMinimum(@jakarta.annotation.Nullable Integer intMinimum) {
  ...
  public EffectsEntry intMaximum(@jakarta.annotation.Nullable Integer intMaximum) {
  ...
  public EffectsEntry type(@jakarta.annotation.Nullable SetEffectsEntryType type) {
    this.type = type;
    return this;
  }
  ...
  public EffectsEntry ignoreIntMin(@jakarta.annotation.Nullable Boolean ignoreIntMin) {
  ...
  public EffectsEntry ignoreIntMax(@jakarta.annotation.Nullable Boolean ignoreIntMax) {
  ...
  public EffectsEntry formatted(@jakarta.annotation.Nullable String formatted) {
