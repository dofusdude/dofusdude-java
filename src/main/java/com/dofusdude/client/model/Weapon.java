...
public class Weapon {
  ...
  public Weapon type(@jakarta.annotation.Nullable ItemsListEntryTypedType type) {
    this.type = type;
    return this;
  }
  ...
  public Weapon imageUrls(@jakarta.annotation.Nullable ImageUrls imageUrls) {
  ...
  public Weapon effects(@jakarta.annotation.Nullable List<EffectsEntry> effects) {
  ...
  @Deprecated
  public Weapon conditions(@jakarta.annotation.Nullable List<ConditionEntry> conditions) {
  ...
  public Weapon conditionTree(@jakarta.annotation.Nullable ConditionTreeNode conditionTree) {
  ...
  public Weapon isTwoHanded(@jakarta.annotation.Nullable Boolean isTwoHanded) {
  ...
  public Weapon range(@jakarta.annotation.Nullable WeaponRange range) {
    this.range = range;
    return this;
  }
  ...
  public void setRange(@jakarta.annotation.Nullable WeaponRange range) {
    this.range = range;
  }


  public Weapon recipe(@jakarta.annotation.Nullable List<RecipeEntry> recipe) {
    this.recipe = recipe;
    return this;
  }
  ...
  public Weapon parentSet(@jakarta.annotation.Nullable ItemListEntryParentSet parentSet) {
