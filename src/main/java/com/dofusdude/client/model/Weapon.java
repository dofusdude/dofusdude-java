...
public class Weapon {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ankama_id", "name", "description", "type", "is_weapon", "level", "pods", "image_urls", "effects", "conditions", "critical_hit_probability", "critical_hit_bonus", "max_cast_per_turn", "ap_cost", "range", "recipe", "parent_set"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Weapon.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Weapon is not found in the empty JSON string", Weapon.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Weapon.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Weapon` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
