...
public class ConditionTreeRelation {
  ...
  public ConditionTreeRelation isOperand(@jakarta.annotation.Nullable Boolean isOperand) {
  ...
  public ConditionTreeRelation relation(@jakarta.annotation.Nullable String relation) {
  ...
  public ConditionTreeRelation children(@jakarta.annotation.Nullable List<ConditionTreeNode> children) {
  ...
  public void setChildren(@jakarta.annotation.Nullable List<ConditionTreeNode> children) {
    this.children = children;
  }
