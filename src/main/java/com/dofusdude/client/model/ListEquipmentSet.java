...
public class ListEquipmentSet {
  ...
  public ListEquipmentSet containsCosmetics(@jakarta.annotation.Nullable Boolean containsCosmetics) {
  ...
  public ListEquipmentSet containsCosmeticsOnly(@jakarta.annotation.Nullable Boolean containsCosmeticsOnly) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ankamaId, listEquipmentSet.ankamaId) &&
        ...
        Objects.equals(this.containsCosmetics, listEquipmentSet.containsCosmetics) &&
        Objects.equals(this.containsCosmeticsOnly, listEquipmentSet.containsCosmeticsOnly);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ankamaId, name, items, level, effects, equipmentIds, containsCosmetics, containsCosmeticsOnly);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ankama_id", "name", "items", "level", "effects", "equipment_ids", "contains_cosmetics", "contains_cosmetics_only"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListEquipmentSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListEquipmentSet is not found in the empty JSON string", ListEquipmentSet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListEquipmentSet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListEquipmentSet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
