...
public class ConditionRelation {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("is_operand", "relation", "children"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConditionRelation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ConditionRelation is not found in the empty JSON string", ConditionRelation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConditionRelation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ConditionRelation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
