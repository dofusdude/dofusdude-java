...
public class GetMetaVersion200Response {
  ...
  public GetMetaVersion200Response version(@jakarta.annotation.Nullable String version) {
  ...
  public GetMetaVersion200Response release(@jakarta.annotation.Nullable String release) {
  ...
  public GetMetaVersion200Response updateStamp(@jakarta.annotation.Nullable String updateStamp) {
