...
public class MountsListPaged {
  ...
  public MountsListPaged links(@jakarta.annotation.Nullable LinksPaged links) {
    this.links = links;
    return this;
  }
  ...
  public MountsListPaged items(@jakarta.annotation.Nullable List<MountListEntry> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@jakarta.annotation.Nullable List<MountListEntry> items) {
    this.items = items;
  }
