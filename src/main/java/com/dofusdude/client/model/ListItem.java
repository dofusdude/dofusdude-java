...
public class ListItem {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ankama_id", "name", "type", "level", "image_urls", "recipe", "description", "conditions", "effects", "is_weapon", "pods", "parent_set", "critical_hit_probability", "critical_hit_bonus", "max_cast_per_turn", "ap_cost", "range"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListItem is not found in the empty JSON string", ListItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
