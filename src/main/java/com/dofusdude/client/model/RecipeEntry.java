...
public class RecipeEntry {
  ...
  public RecipeEntry itemAnkamaId(@jakarta.annotation.Nullable Integer itemAnkamaId) {
  ...
  public RecipeEntry itemSubtype(@jakarta.annotation.Nullable String itemSubtype) {
  ...
  public RecipeEntry quantity(@jakarta.annotation.Nullable Integer quantity) {
