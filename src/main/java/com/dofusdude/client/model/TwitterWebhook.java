...
public class TwitterWebhook {
  ...
  public TwitterWebhook id(@jakarta.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public TwitterWebhook whitelist(@jakarta.annotation.Nullable List<String> whitelist) {
  ...
  public TwitterWebhook blacklist(@jakarta.annotation.Nullable List<String> blacklist) {
  ...
  public TwitterWebhook subscriptions(@jakarta.annotation.Nullable List<String> subscriptions) {
  ...
  public TwitterWebhook format(@jakarta.annotation.Nullable FormatEnum format) {
    this.format = format;
    return this;
  }
  ...
  public TwitterWebhook previewLength(@jakarta.annotation.Nullable Integer previewLength) {
  ...
  public TwitterWebhook createdAt(@jakarta.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public TwitterWebhook lastFiredAt(@jakarta.annotation.Nullable OffsetDateTime lastFiredAt) {
  ...
  public TwitterWebhook updatedAt(@jakarta.annotation.Nullable OffsetDateTime updatedAt) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "whitelist", "blacklist", "subscriptions", "format", "preview_length", "created_at", "last_fired_at", "updated_at"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TwitterWebhook.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TwitterWebhook is not found in the empty JSON string", TwitterWebhook.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TwitterWebhook.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TwitterWebhook` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("whitelist") != null && !jsonObj.get("whitelist").isJsonNull() && !jsonObj.get("whitelist").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `whitelist` to be an array in the JSON string but got `%s`", jsonObj.get("whitelist").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("blacklist") != null && !jsonObj.get("blacklist").isJsonNull() && !jsonObj.get("blacklist").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `blacklist` to be an array in the JSON string but got `%s`", jsonObj.get("blacklist").toString()));
      }
      // ensure the optional json data is an array if present
