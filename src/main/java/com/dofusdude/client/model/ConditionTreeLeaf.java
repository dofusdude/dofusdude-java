...
public class ConditionTreeLeaf {
  ...
  public ConditionTreeLeaf isOperand(@jakarta.annotation.Nullable Boolean isOperand) {
  ...
  public ConditionTreeLeaf condition(@jakarta.annotation.Nullable ConditionEntry condition) {
  ...
  public void setCondition(@jakarta.annotation.Nullable ConditionEntry condition) {
    this.condition = condition;
  }
