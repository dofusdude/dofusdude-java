...
import com.dofusdude.client.model.ResourceType;
...
public class Resource {
  ...
  public Resource type(@jakarta.annotation.Nullable ResourceType type) {
    this.type = type;
    return this;
  }
  ...
  public void setType(@jakarta.annotation.Nullable ResourceType type) {
    this.type = type;
  }
  ...
  public Resource imageUrls(@jakarta.annotation.Nullable ImageUrls imageUrls) {
  ...
  public Resource effects(@jakarta.annotation.Nullable List<EffectsEntry> effects) {
  ...
  @Deprecated
  public Resource conditions(@jakarta.annotation.Nullable List<ConditionEntry> conditions) {
  ...
  public Resource conditionTree(@jakarta.annotation.Nullable ConditionTreeNode conditionTree) {
  ...
  public Resource recipe(@jakarta.annotation.Nullable List<RecipeEntry> recipe) {
    this.recipe = recipe;
    return this;
  }
