...
public class Mount {
  ...
  public Mount familyName(@jakarta.annotation.Nullable String familyName) {
  ...
  public Mount imageUrls(@jakarta.annotation.Nullable ImageUrls imageUrls) {
  ...
  public Mount effects(@jakarta.annotation.Nullable List<EffectsEntry> effects) {
