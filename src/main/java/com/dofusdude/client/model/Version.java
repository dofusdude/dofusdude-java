...
public class Version {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("update_stamp") != null && !jsonObj.get("update_stamp").isJsonNull()) && !jsonObj.get("update_stamp").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `update_stamp` to be a primitive type in the JSON string but got `%s`", jsonObj.get("update_stamp").toString()));
      }
  }
