...
public class AlmanaxEntryTribute {
  ...
  public AlmanaxEntryTribute item(@jakarta.annotation.Nullable AlmanaxEntryTributeItem item) {
    this.item = item;
    return this;
  }
  ...
  public void setItem(@jakarta.annotation.Nullable AlmanaxEntryTributeItem item) {
    this.item = item;
  }


  public AlmanaxEntryTribute quantity(@jakarta.annotation.Nullable Integer quantity) {
