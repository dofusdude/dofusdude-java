...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.dofusdude.client.model.GetMetaVersion200Response.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.dofusdude.client.model.ResourceType.CustomTypeAdapterFactory());
