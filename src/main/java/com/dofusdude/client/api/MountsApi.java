...
public class MountsApi {
     ...
     */
    public List<Mount> getMountsSearch(String language, String game, String query, String filterFamilyName, Integer limit) throws ApiException {
        ApiResponse<List<Mount>> localVarResp = getMountsSearchWithHttpInfo(language, game, query, filterFamilyName, limit);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Mount>> getMountsSearchWithHttpInfo(String language, String game, String query, String filterFamilyName, Integer limit) throws ApiException {
     ...
     */
    public okhttp3.Call getMountsSearchAsync(String language, String game, String query, String filterFamilyName, Integer limit, final ApiCallback<List<Mount>> _callback) throws ApiException {
