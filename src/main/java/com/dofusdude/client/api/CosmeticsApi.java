...
@Path("/{game}/{language}/items/cosmetics")
public interface CosmeticsApi  {
    ...
    @Path("/{ankama_id}")
    @Produces({ "application/json" })
    Cosmetic getCosmeticsSingle(@PathParam("language") String language, @PathParam("ankama_id") Integer ankamaId, @PathParam("game") String game) throws ApiException, ProcessingException;
}
