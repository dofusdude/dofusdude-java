...
public class AlmanaxApi {
     ...
     */
    public AlmanaxEntry getAlmanaxDate(String language, LocalDate date) throws ApiException {
        ApiResponse<AlmanaxEntry> localVarResp = getAlmanaxDateWithHttpInfo(language, date);
     ...
     * @param language code (required)
     * @param date yyyy-mm-dd (required)
     * @return ApiResponse&lt;AlmanaxEntry&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AlmanaxEntry> getAlmanaxDateWithHttpInfo(String language, LocalDate date) throws ApiException {
        okhttp3.Call localVarCall = getAlmanaxDateValidateBeforeCall(language, date, null);
        Type localVarReturnType = new TypeToken<AlmanaxEntry>(){}.getType();
     ...
     */
    public okhttp3.Call getAlmanaxDateAsync(String language, LocalDate date, final ApiCallback<AlmanaxEntry> _callback) throws ApiException {
     ...
     */
    public List<AlmanaxEntry> getAlmanaxRange(String language, String filterBonusType, LocalDate rangeFrom, LocalDate rangeTo, Integer rangeSize, String timezone) throws ApiException {
        ApiResponse<List<AlmanaxEntry>> localVarResp = getAlmanaxRangeWithHttpInfo(language, filterBonusType, rangeFrom, rangeTo, rangeSize, timezone);
        return localVarResp.getData();
    }
     ...
     * @param rangeSize size of the returned range (optional)
     * @param timezone determine what the current time is. If you live in Brazil, \&quot;today\&quot; will be hours apart from Paris. Use your timezone to get results relative to your location. (optional, default to Europe/Paris)
     * @return ApiResponse&lt;List&lt;AlmanaxEntry&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<AlmanaxEntry>> getAlmanaxRangeWithHttpInfo(String language, String filterBonusType, LocalDate rangeFrom, LocalDate rangeTo, Integer rangeSize, String timezone) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<AlmanaxEntry>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getAlmanaxRangeAsync(String language, String filterBonusType, LocalDate rangeFrom, LocalDate rangeTo, Integer rangeSize, String timezone, final ApiCallback<List<AlmanaxEntry>> _callback) throws ApiException {
