...
import com.dofusdude.client.auth.Authentication;
import com.dofusdude.client.auth.HttpBasicAuth;
import com.dofusdude.client.auth.HttpBearerAuth;
import com.dofusdude.client.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.0.0-rc.10/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.dofusdu.de
     ...
     * @return a {@link com.dofusdude.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.dofusdude.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.dofusdude.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.dofusdude.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.dofusdude.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.dofusdude.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.dofusdude.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.dofusdude.client.ApiException If fails to update the parameters
     */
