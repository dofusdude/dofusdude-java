...
public class EquipmentApiTest {
    ...
    public void getAllItemsEquipmentListTest() {
        ...
        //ItemsListPaged response = api.getAllItemsEquipmentList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding);
    ...
    public void getItemsEquipmentListTest() {
        ...
        //ItemsListPaged response = api.getItemsEquipmentList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem);
        //assertNotNull(response);
    ...
    public void getItemsEquipmentSearchTest() {
        ...
        Integer filterMaxLevel = null;
        Integer limit = null;
        //List<ItemListEntry> response = api.getItemsEquipmentSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit);
        //assertNotNull(response);
