...
public class SetsApiTest {
    ...
    public void getAllSetsListTest() {
        ...
        //SetsListPaged response = api.getAllSetsList(language, game, sortLevel, filterMinHighestEquipmentLevel, filterMaxHighestEquipmentLevel, acceptEncoding);
    ...
    public void getSetsListTest() {
        ...
        //SetsListPaged response = api.getSetsList(language, game, sortLevel, filterMinHighestEquipmentLevel, filterMaxHighestEquipmentLevel, pageSize, pageNumber, fieldsSet);
        //assertNotNull(response);
    ...
    public void getSetsSearchTest() {
        ...
        Integer filterMaxHighestEquipmentLevel = null;
        Integer limit = null;
        //List<SetListEntry> response = api.getSetsSearch(language, game, query, filterMinHighestEquipmentLevel, filterMaxHighestEquipmentLevel, limit);
        //assertNotNull(response);
